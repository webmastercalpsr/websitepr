...
import flyerfa26 from '../../assets/Fall2026/phirhodeo.png'
import sinaAnna from '../../assets/Fall2026/SinaAnna.png'

import sina from '../../assets/Spring2026/sina.png'

const Fall2026 = () => {
  return (
    <div className="fall2026-container">
      <div className="buttons-container">
        <a href="https://airtable.com/app2HDaWTE6yZEtJ7/pagHBKBLmQt88Q3oM/form" className="recruitment-button">Interest Form</a>
        <a href="https://airtable.com/app2HDaWTE6yZEtJ7/pagGDm61sHCEAtPF5/form" className="recruitment-button">Request a Coffee Chat!</a>
       <a href="https://calphirho.notion.site/Phi-Sigma-Rho-Spring-26-Recruitment-fefbdad2e7844eafa16fade5f723f4a4" className="recruitment-button">Recruitment Timeline</a>
      ...
      <div className="content-container">
        ...
        <div className="flyers-column">
          <img src={flyerfa26} alt="Recruitment Flyer Page 1" className="flyer-img" />
          {/* <img src={flyerfa25p2} alt="Recruitment Flyer Page 2" className="flyer-img" /> */}
        </div>

        {/* Right column: letter + photo */}
        <div className="letter-column">
          <div className="letter-container">
            <h2 className="letter-header1">DEAR POTENTIAL NEW MEMBERS,</h2>
            <p className="letter-paragraph">
              Hi there! <br /><br />
              We're Sina and Anna, and we're thrilled to serve as your Recruitment Chairs this Fall. 
          ...
          <img src={sinaAnna} alt="Sina & Anna" className="sinaAnna" />
        </div>
      </div>
    </div>
  );
